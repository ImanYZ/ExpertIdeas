...
__version__ = '$Id: 676fc716a1e8d2099e8b4056ffd24982712d0fc1 $'
...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ar', 'ko', 'ms', 'hu', 'ro', 'sr', 'tr', 'min', 'kk', 'eo', 'sh',
            'sk', 'da', 'eu', 'lt', 'bg', 'he', 'hr', 'sl', 'uz', 'et', 'hy',
            ...
            'kn', 'am', 'ia', 'ckb', 'nap', 'bug', 'bat-smg', 'wa', 'map-bms',
            'mn', 'arz', 'mzn', 'pa', 'si', 'zh-min-nan', 'yi', 'sah', 'vec',
            'fo', 'sa', 'bar', 'nah', 'os', 'roa-tara', 'pam', 'or', 'hsb',
            ...
            'as', 'bh', 'cbk-zam', 'gn', 'pi', 'pcd', 'gag', 'ksh', 'nov',
            ...
            'rmy', 'cu', 'tw', 'tn', 'chr', 'roa-rup', 'om', 'got', 'bi', 'pih',
            'sm', 'rn', 'bm', 'ss', 'iu', 'sd', 'pnt', 'ki', 'xh', 'ts', 'ee',
            'ak', 'fj', 'ti', 'ks', 'lg', 'sg', 'ny', 'ff', 've', 'cr', 'st',
            'dz', 'tum', 'ik', 'ch',
        ]
